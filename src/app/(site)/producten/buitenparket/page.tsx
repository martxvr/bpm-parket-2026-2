...
export default function BuitenparketPage() {
  ...
  const werkwijze = [
    ...
    { title: '3. Vakkundige montage', desc: 'Ons eigen team legt uw buitenvloer — van onderconstructie tot afwerking. Zonder stress, zonder rommel.' },
  ]
    ...
    <main className="min-h-screen bg-brand-bg-light">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20">
        <h2 className="text-3xl md:text-4xl font-bold text-brand-dark mb-6">
          Buitenparket — schoonheid en functionaliteit voor uw tuin
        </h2>
      ...
      <section className="bg-brand-accent py-20">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-brand-dark mb-12 text-center">Waarom BPM Parket voor uw buitenparket?</h2>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-brand-dark mb-6">Klaar voor een duurzaam terras?</h2>
