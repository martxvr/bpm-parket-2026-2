...
export default function PvcLaminaatPage() {
    ...
    <main className="min-h-screen bg-brand-bg-light">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20">
        <h2 className="text-3xl md:text-4xl font-bold text-brand-dark mb-6">
          PVC en Laminaat — duurzaamheid en stijl gecombineerd
        </h2>
        <div className="prose prose-lg text-brand-text">
          <p>
            PVC vloeren combineren stijl met duurzaamheid voor een perfecte woningafwerking. Of u nu kiest
            voor een modern laminaat, duurzame PVC-vinyl of een waterdichte hybride vloer — wij leveren
            en leggen alles met hetzelfde vakmanschap dat u van BPM Parket verwacht.
          </p>
          <p>
            Van Belgische Quick-Step tot Nederlands Forbo Novilon — onze collectie dekt elk budget en elke stijl.
          </p>
        </div>
      </section>
      ...
      <section className="bg-brand-accent py-20">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-brand-dark mb-12 text-center">Waarom BPM Parket voor uw PVC of laminaat?</h2>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-brand-dark mb-6">Klaar voor uw nieuwe PVC of laminaat vloer?</h2>
