...
import { Award, ShieldCheck, Leaf, Star, ArrowRight } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Over ons',
  description:
    'BPM Parket is een familiebedrijf uit Geldrop met meer dan 20 jaar ervaring in parket, PVC-vloeren en traprenovaties.',
};
    ...
    <div className="flex flex-col w-full overflow-hidden bg-white text-brand-dark">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/offerte"
            className="inline-flex items-center gap-2 bg-brand-red text-white font-semibold px-8 py-4 rounded-full hover:bg-brand-red/90 transition-colors"
          >
