  ...
  return (
    <div className="relative">
      <button
        ...
        type="button"
        onClick={openPicker}
        className={`w-full p-4 rounded-xl text-left flex items-center justify-between focus:outline-none focus:ring-2 focus:ring-brand-red/50 transition-all border ${
          isDark
